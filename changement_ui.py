...
add_a_new_rect("RECT", character_rect, WHITE, Rects_dic, ID_dic, get_highest_ID(ID_dic))
add_a_new_rect("RECT", ideology_rect, WHITE, Rects_dic, ID_dic, get_highest_ID(ID_dic))
...
while running:
    ...
    blit_screen(screen, BACKGROUND_COLOR)
