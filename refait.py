...
class Entity:
    def __init__(self, characteristics, ideology): # [name, damage, hp, defense, speed, precision]
...
"""
Me = create_someone(Entities, "gentil")
Me.presentation()

Mechant = create_someone(Entities, "mechant")
